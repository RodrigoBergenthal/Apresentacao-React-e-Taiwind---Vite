        ...
        <h2 className="text-4xl font-bold w-48 mb-12 bg-gradient-to-r from-red-800 to-red-300'">Sobre min</h2>
          <div className="animate-fade-down animate-thrice animate-duration-[2000ms] animate-delay-[5ms] animate-ease-linear">
            <p className="text-lg mb-8 ">
              Essa e uma apresentação pessoal para o projeto Front end Fusion aonde quero me apresentar e contar um pouco da minha Historia: <br />
            ...
            Comprometido com o aprendizado contínuo e autodidata, valorizo o respeito e a colaboração no ambiente de trabalho. <br />
            Sou casado a 20 anos e tenho um filho de 16 que e programador também aonde fizemos muitos projetos e estudamos ingles juntos, fora eu estar com a minha
            familia eu passo a maior parte do tempo jogando na steam ou assistindo um anime!
          </p></div>
